...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      {/* Header */}
      jsx<header className="bg-white shadow-lg">
      ...
      {/* Contact Section */}
      <section id="contact-us-section" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <a href="https://u.wechat.com/kI4ZUUbJJk7wu-aTxURdJOE?s=2" target="_blank" rel="noopener noreferrer"><Badge variant="outline">WeChat</Badge></a>
                    </div>
                  </CardContent>
                </Card>
      ...
      {/* Footer */}
      <footer className="bg-[#8B1A1A] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-3 mb-4">
                <img src="/Marvlin-logo.png" alt="Marvel In Company Limited Logo" className="w-8 h-8" />
